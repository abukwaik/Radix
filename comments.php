...
<div id="comments" class="comments-area">
  ...
  <?php if (comments_open()) : ?>
    <?php $comments_args = array(
      ...
      'comment_field'        => '<div class="row"><div class="wpbs-textarea col-md-12"><label for="Text area"><span class="screen-reader-text">' . sprintf( __('text_area', RTD) ) . '</span>' .
      '<textarea class="form-control" id="comment" name="comment" rows="8" aria-required="true" placeholder="Start commenting..."></textarea>' . '</label></div>' ,
