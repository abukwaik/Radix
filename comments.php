...
<div id="comments" class="comments-area">
  ...
  <?php if (comments_open()) : ?>
    <?php $comments_args = array(
      ...
      '<label for="text_area" class="screen-reader-text">' . sprintf( __('Text area', RTD) ) . '</label>' .
      ...
      'fields' => apply_filters( 'comment_form_default_fields', array(
        'author' => '<div class="row">' . 
          ...
          '<label for="name" class="screen-reader-text">' . sprintf( __('Name', RTD) ) . '</label><input class="form-control" placeholder="Your name" id="name" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" aria-required="true" />' .
          '</div></div>',
          'email' => '<div class="col-md-6 col-xs-6">' .
          '<div class="input-group">' . 
          '<span class="input-group-addon"><i class="fa fa-envelope" aria-hidden="true"></i></span>' . 
          '<label for="email" class="screen-reader-text">' . sprintf( __('Email', RTD) ) . '</label><input class="form-control" placeholder="Your email" id="email" name="email" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30" aria-required="true"  />' . 
          '</div></div>' . 
          '</div>',
        'url' => ''
        )),          
