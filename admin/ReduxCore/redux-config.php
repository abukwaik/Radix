            ...
            **/
            ...
            public function setHelpTabs() {
                ...
                $this->args['help_tabs'][] = array(
                    ...
                    'content' => __( '<p>Go to <a class="external" href="' . esc_url('http://www.radixtheme.com/starter.html') . '" target="_blank">Radix Documentation</a> to learn more about Radix features.</p>', 'radix' )
                );

                $this->args['help_tabs'][] = array(
                    'id'      => 'redux-help-tab-2',
                    'title'   => __( 'Issues tracker', 'radix' ),
                    'content' => __( '<p>If you have any issue do not hesitate to join the <a class="external" href="' . esc_url('https://github.com/abukwaik/Radix/issues') . '" target="_blank">issues tracker</a></p>', 'radix' )
                );
                $this->args['help_tabs'][] = array(
                    'id'      => 'redux-help-tab-3',
                    'title'   => __( 'Donation ', 'radix' ),
                    'content' => __( '<p>Please consider <a class="external" href="' . esc_url('https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=JUXUWMEFUEJPW') . '" target="_blank">donating</a> so we can keep this as a free theme and add more features in the future</p>', 'radix' )
                );
